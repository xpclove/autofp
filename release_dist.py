...
if __name__ == "__main__":
    ...
    shutil.copy("README.html", "autofp_pkg/README.html")
    ...
    shutil.copytree("prf2origin/prf2origin/origin",
                    "autofp_pkg/dist/prf2origin/prf2origin/origin")
    t = time.time()
    ...
    shutil.copy("README.txt", "AutoFP/README.txt")
    shutil.copy("README.html", "AutoFP/README.html")
